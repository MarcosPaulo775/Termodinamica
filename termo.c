...
void TemperaturaFinal(El x , El y){
    ...
    if(cont == 2){
        printf("A temperatura de equilibrio entre os elementos é de : %.2f K",TF);
    }else{
        printf("HOUVE MUDANÇAS DE FASES!");
    }
...
El trata_erro(El x){
    if(x.id == 1 && x.temp_atual > x.temp_fusao){
        do{
        printf(" --------------- ERRO! ----------------\n");
        printf("O elemento[%s] não e existente a essa temperatura(%.2fK)!\n",x.nome,x.temp_atual);
        printf("Por favor digite a temperatura do elemento[%s] novamente: ",x.nome);
...
int main(){
    ...
    printf("DIGITE O NUMERO DO PRIMEIRO ELEMENTO:\n1-Gelo \n"
                                                  "2-Agua \n"
                                                  "3-Etanol \n"
                                                  "4-Mercurio \n"
                                                  "5-Vidro \n"
    ...
    printf("DIGITE O NUMERO DO SEGUNDO ELEMENTO: \n1-Gelo \n"
                                                  "2-Agua \n"
                                                  "3-Etanol \n"
                                                  "4-Mercurio \n"
                                                  "5-Vidro \n"
    ...
    printf("\n-------------------------------------- \n");
    printf("ATENÇÃO: MASSA EM GRAMAS!");
    printf("\n-------------------------------------- \n");
    //Coletando as massas
    printf("Digite a massa do elemento 1[%s]: ",x.nome);
    scanf("%f",&x.massa);
    printf("Digite a massa do elemento 2[%s]: ",y.nome);
    scanf("%f",&y.massa);

    printf("\n -------------------------------------- \n");
    printf("ATENÇÃO: TEMPERATURA EM KELVIN!");
    printf("\n -------------------------------------- \n");
    //Coletando as temperaturas
    printf("Digite a temperatura do elemento 1[%s]: ",x.nome);
    scanf("%f",&x.temp_atual);
    printf("Digite a temperatura do elemento 2[%s]: ",y.nome);
    ...
    printf("\n\nDeseja fazer outra medição?[s/n]\n");
    printf("-> ");
    scanf("%s",&resp);
    printf("\n\n\n");
